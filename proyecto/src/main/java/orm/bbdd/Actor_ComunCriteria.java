...
public class Actor_ComunCriteria extends AbstractORMCriteria {
	...
	public Actor_ComunCriteria(PersistentSession session) {
		this(session.createCriteria(Actor_Comun.class));
	}
	
	public Actor_ComunCriteria() throws PersistentException {
	...
	public Actor_Comun uniqueActor_Comun() {
		return (Actor_Comun) super.uniqueResult();
	}
	
	public Actor_Comun[] listActor_Comun() {
