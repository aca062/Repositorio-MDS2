...
public class Actor_ComunDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public Actor_Comun uniqueActor_Comun(PersistentSession session) {
		return (Actor_Comun) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Actor_Comun[] listActor_Comun(PersistentSession session) {
