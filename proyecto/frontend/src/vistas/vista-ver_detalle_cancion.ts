...
<vaadin-vertical-layout style="width: 100%; height: 100%; align-items: center;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout theme="spacing-xl" id="vaadinHorizontalLayout" style="margin-top: 8%; width: 100%; justify-content: center; background-color: var(--lumo-contrast-10pct); padding: var(--lumo-space-xl);">
  ...
  <vaadin-vertical-layout theme="spacing" id="vaadinVerticalLayout2" style="align-self: center; width: 50%;">
   ...
   <vaadin-horizontal-layout theme="spacing" id="vaadinHorizontalLayout1" style="width: 120%; align-items: center;">
    ...
    <vaadin-select value="Añadir a lista de reproduccion" id="vaadinSelect" style="width: 50%;">
     <template>
