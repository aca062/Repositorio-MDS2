...
<vaadin-horizontal-layout class="content" style="align-items: center; width: 100%; height: 200px; padding: var(--lumo-space-s); padding-top: 0;" id="layoutPrincipal">
 <img id="botonCancion" style="margin: var(--lumo-space-s); background-repeat:no-repeat; background-size: 150px 150px; background-position:center; width: 150px; height: 150px; object-fit: contain;">
