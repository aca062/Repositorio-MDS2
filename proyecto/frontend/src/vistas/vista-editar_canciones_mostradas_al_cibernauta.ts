...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-vertical-layout id="vaadinVerticalLayout1" style="margin-left: var(--lumo-space-xl); width: 90%; background-color: var(--lumo-contrast-10pct); padding: var(--lumo-space-xl);">
  ...
  <vaadin-list-box id="vaadinListBox" style="align-self: flex-start; width: 80%;">
   <vaadin-horizontal-layout style="justify-content: space-between; width: 70%;">
