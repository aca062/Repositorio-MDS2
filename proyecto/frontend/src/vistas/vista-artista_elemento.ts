...
export class VistaArtista_elemento extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="width: 100%; height: 150px; align-items: flex-start; justify-content: center;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout theme="spacing" id="vaadinHorizontalLayout" style="padding: var(--lumo-space-s); width: 100%; align-items: center; height: 200px;">
