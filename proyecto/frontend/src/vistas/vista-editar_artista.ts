...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-vertical-layout style="height: 600px; margin-left: var(--lumo-space-xl); background-color: var(--lumo-contrast-10pct); width: 90%; padding: var(--lumo-space-xl);" id="vaadinVerticalLayout1">
