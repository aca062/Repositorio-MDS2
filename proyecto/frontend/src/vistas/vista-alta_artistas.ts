...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout id="vaadinHorizontalLayout" style="width: 90%; height: 20%; margin-left: 10%;">
 ...
 <vaadin-horizontal-layout id="vaadinHorizontalLayout1" style="margin-left: 10%;">
  <vaadin-text-field label="Nick" id="nick"></vaadin-text-field>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout id="vaadinHorizontalLayout2" style="margin-left: 10%;">
  <vaadin-text-field label="Contraseña" id="contraseña"></vaadin-text-field>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout id="vaadinHorizontalLayout3" style="margin-left: 10%;">
  <vaadin-text-field label="Confirmar contraseña" id="confirmarContraseña"></vaadin-text-field>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout id="vaadinHorizontalLayout4" style="margin-left: 10%;">
  <vaadin-text-field label="E-mail" id="eMail"></vaadin-text-field>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout id="vaadinHorizontalLayout5" style="margin-left: 10%;">
