...
<vaadin-vertical-layout style="width: 100%; height: 100%; align-items: center;" id="layoutPrincipal">
 <vaadin-vertical-layout id="layoutAlbum" style="flex-grow: 0; margin: var(--lumo-space-l); align-items: flex-start; width: 45%; align-self: center;">
  <vista-album id="vistaAlbum" style="flex-grow: 0; flex-shrink: 1; margin: var(--lumo-space-m); align-self: center;"></vista-album>
